...
def main():
    ...
    while step != step_size:
        ...
        with Profiler("Simulator step"):
            ...
            cv2.imwrite("/home/ubuntu/Desktop/iGibson_study/igibson_dataset/easy07/rgb/" + str(step) + ".png",
                        rgb_image)
            cv2.imwrite("/home/ubuntu/Desktop/iGibson_study/igibson_dataset/easy07/depth/" + str(step) + ".png", depth)
            time.sleep(0.05)

    s.disconnect()

    with open('/home/ubuntu/Desktop/iGibson_study/igibson_dataset/easy07/pose_truth.txt', 'w') as f:
