...
def main():
    ...
    while step != step_size:
        ...
        with Profiler("Simulator step"):
            ...
            # cv2.imwrite("/home/ubuntu/Desktop/iGibson_study/igibson_dataset/rgb/" + str(step) + ".png", rgb_image)
            # cv2.imwrite("/home/ubuntu/Desktop/iGibson_study/igibson_dataset/depth/" + str(step) + ".png", depth)
            time.sleep(0.05)
